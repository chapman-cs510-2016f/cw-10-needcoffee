...
int main(void)
{
    ...
    */
    ...
    print_arrays(array_size, array, memblock);
...
void set_arrays(int arraySize, float *anArray, long double *memBlock) {
...
void print_arrays(int arraySize, float * anArray, long double *memBlock) {
